#!/bin/sh
#
# add-sims-old: Perform EXOSIMS simulations, accumulating runs into subdirectories
#
# === THIS IS THE 2018-2019 VERSION ===
#
# This is a wrapper around the python driver, ipcluster_ensemble_jpl.py.
#
# Usage:
#   add-sims-old [-3] [-q] [-v VERB] [-S SEEDS] [-P PAR] [-x SCRIPT] [-e] [-E ADDR] [-O OPTS] SCRIPT N
#
