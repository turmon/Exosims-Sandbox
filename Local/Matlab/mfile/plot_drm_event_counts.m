...
style_count_plot('Mean Event Count: Detection and Characterization Attempts', ...
                 'Number of Events [count]', ...
                 'Frequency [density]', names_legend);
write_plots('event-count-det');

% zoomed
style_count_plot('Mean Event Count: Detection and Characterization Attempts (Zoomed)', ...
                 'Number of Events [count]', ...
                 'Frequency [density]', names_legend);
axis([-Inf 100 0 Inf]);
...
if ismember('h_event_count_det_rvplan_mean', t_counts.Properties.VariableNames),
    ...
    style_count_plot('Mean Event Count: RV Detection and Characterization Attempts', ...
                     'Number of Events [count]', ...
                     'Frequency [density]', names_legend);
    axis([-Inf 30 0 Inf]);
