...
% 2023-11-04: removing the red/blue/union dual-mode chars
%  x   {'',  '_union_',  '',       'dual', 'radlum-char-union'}, ...
%  x   {'',  '_blue_',   'Blue',   'dual', 'radlum-char-blue'}, ...
%  x   {'',  '_red_',    'Red',    'dual', 'radlum-char-red'}, ...
char_plot_menu = {...
    {'',  '_',        '',             'dual', 'radlum-char'}, ...
...
% descriptive title-word blank, to signal that this qualifier is omitted 
% in the plot title as shown.
% 2023-11-04: removing dual-mode chars
%  Adjusting "Legacy" to have the omitted qualifier
