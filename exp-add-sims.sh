...
# 
# Complete Usage:
#   exp-add-sims.sh [-0] [-j N] [[-m target,target,...] ...] [-q|-v] Experiment Seeds
#
# where arguments are:
...
# conventional/findable locations under this_sim/logs/slurm
this_sim=\$(echo "\$this_script" | sed -e 's|Scripts/|sims/|' -e 's|[.]json||')
this_sim_log_dir="\${this_sim}/logs/slurm"
